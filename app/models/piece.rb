class Piece < ActiveRecord::Base
  ...
  def move_to!(params)
    ...
    enemy_pawn = enemy_location(color, new_x, vertical_position)
  ...
  def enemy_location(color, new_x, vertical_position)
    if color == 'white'
      game.pieces.find_by(type: 'Pawn', horizontal_position: new_x, vertical_position: vertical_position, color: 'black', passant: true)
    else
      game.pieces.find_by(type: 'Pawn', horizontal_position: new_x, vertical_position: vertical_position, color: 'white', passant: true)
    end
  end
